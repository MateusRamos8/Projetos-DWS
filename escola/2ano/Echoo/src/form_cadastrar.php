...
<main class="flex flex-col justify-center items-center gap-5 text-neutral-300">
    ...
    <form action="inserir_usuario.php" method="post" class="flex flex-col gap-4">
        ...
        <div class="flex flex-col">
            <input type="url" name="url_imagem" id="url_imagem" placeholder="URL da Imagem de Perfil" class="select-none bg-transparent w-80 border-b-white border-2 rounded-xl p-3 focus:outline-none" required>
        </div>
        <div class="flex flex-col">
            <input type="email" name="email" id="email" placeholder="E-mail" class="select-none bg-transparent w-80 border-b-white border-2 rounded-xl p-3 focus:outline-none" required>
        </div>
        <div class="flex flex-col">
        ...
        <div class="flex flex-col">
            <input type="password" name="confirmar_senha" id="confirmar_senha" placeholder="Confirmar Senha" class="select-none bg-transparent w-80 border-b-white border-2 rounded-xl p-3 focus:outline-none" onblur="verifica_senhas();" required>
        </div>
