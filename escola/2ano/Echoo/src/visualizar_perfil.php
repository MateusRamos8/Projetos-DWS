                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-4 items-center">
                        ...
                        if($_SESSION["id_usuario"] == $id){
                            ?>
                            <a href="form_editar_usuarios.php?id=<?=$_SESSION["id_usuario"]?>&ad=<?=$_SESSION["administrador"]?>" class="flex items-center justify-center gap-2 bg-rose-900 text-neutral-200 py-2 px-4 rounded-lg select-none">
